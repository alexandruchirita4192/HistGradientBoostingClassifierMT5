...
## Exemplu rulare
```powershell
python train_mt5_hgb_classifier.py --symbol XAGUSD --timeframe M15 --bars 20000 --horizon-bars 8 --train-ratio 0.70 --output-dir output_hgb_h8
```

## Pasii pentru MT5
1. Copiaza `ml_strategy_classifier_hgb.onnx` langa fisierul `.mq5`
