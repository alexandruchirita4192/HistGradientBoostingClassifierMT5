...
def write_run_in_mt5(
    ...
    txt = f"""MODEL: HistGradientBoostingClassifier (3 clase)
SIMBOL: {args.symbol}
TIMEFRAME: {args.timeframe}
...
PASII:
1. Copiaza fisierul ml_strategy_classifier_hgb.onnx langa EA-ul .mq5.
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Antreneaza un model HistGradientBoosting pentru MT5 si exporta ONNX.")
    ...
    p.add_argument("--output-dir", default="output_hgb", help="Directorul de output")
